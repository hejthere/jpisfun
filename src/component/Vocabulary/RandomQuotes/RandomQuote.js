...
export default function RandomQuote() {
    ...
    const [quotes] = useState(quoteList);
    ...
    const generateQuoteHandler = () => {
        ...
        setGeneratedQuote(selectedQuote);
        setCanSaveQuote(true)
    ...
    return (
        <Container fluid="true">
            ...
            { isDisplayQuote && <Quotes
                ...
                authorQuote={generatedQuote.author}
            />}

            <br />
            <Button onClick={generateQuoteHandler}>Start</Button>
